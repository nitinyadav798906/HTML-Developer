...
<head>
    ...
    <style>
        ...
        .speed-btn-row {{ display: flex; justify-content: space-around; padding: 10px; background: #f9f9f9; border-top: 1px solid #eee; }}
        .speed-btn-row button {{ border: none; background: #eee; padding: 5px 12px; border-radius: 5px; cursor: pointer; font-size: 12px; font-weight: bold; }}
...
<body>
    ...
    <script>
        ...
        function changeSpeed(s, btn) {{
            player.speed = s;
            document.querySelectorAll('.speed-btn-row button').forEach(b => b.classList.remove('active-speed'));
